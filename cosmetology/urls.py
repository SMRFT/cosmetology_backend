...
urlpatterns = [
    ...
    path('get_medicine_price/', views.get_medicine_price, name='get_medicine_price'),
    ...
    path('get_patientbilling_data/', views.get_patientbilling_data, name='get_patientbilling_data'),
    path('get_patient_procedurebill_data/', views.get_patient_procedurebill_data, name='get_patient_procedurebill_data'),
    path('getnewbill/', views.getnewbill, name='getnewbill'),
    path('getnewprocedurebill/', views.getnewprocedurebill, name='getnewprocedurebill'),
