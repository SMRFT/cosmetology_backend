...
urlpatterns = [
    ...
    path('get/stored/bill/', views.get_stored_bill, name='get_stored_bill'),
    path('get/stored/procedurebill/', views.get_stored_procedurebill, name='get_stored_procedurebill'),
